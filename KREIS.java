...
implements EduActor
{
    ...
    // {
        // this.kreis.getActor().physics.applyImpulse( new ea.Vector( 0 , 1000 * staerke) );
    // }
    ...
    // {
        // return this.kreis.stehtAuf( ea.getActor() );
    // }
    ...
    // {
        // this.kreis.geradenAnimation( ziel_x , ziel_y , milliSec , pingpong );
    // }
    
    
    // public void animationKreis( float zentrum_x , float zentrum_y , int milliSec , boolean uhrzeigersinn , boolean rotation )
    // {
        // this.kreis.kreisAnimation( zentrum_x , zentrum_y , milliSec , uhrzeigersinn , rotation );
    // }
