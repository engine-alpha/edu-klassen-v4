...
implements EduActor
{
    ...
    // {
        // this.rechteck.getActor().physics.applyImpulse( new ea.Vector( 0 , 1000 * staerke) );
    // }
    ...
    // {
        // return this.rechteck.stehtAuf( ea.getActor() );
    // }
    ...
    // {
        // this.rechteck.geradenAnimation( ziel_x , ziel_y , milliSec , pingpong );
    // }
    
    
    // public void animationKreis( float zentrum_x , float zentrum_y , int milliSec , boolean uhrzeigersinn , boolean rotation )
    // {
        // this.rechteck.kreisAnimation( zentrum_x , zentrum_y , milliSec , uhrzeigersinn , rotation );
    // }
    
    // public void setzeReibung(float reibungsKoeffizient) {
        // rechteck.setzeReibung(reibungsKoeffizient);
    // }
